        ...
        <div class="md:w-1/2 order-2 md:order-1">
            <div class="w-full max-w-sm">
                <div class="flex flex-col break-words bg-white border border-2 shadow-md mt-20">
                        ...
                        <form class="py-10 px-5" method="POST" action="{{route('user.update', [Auth::user()->id])}}" novalidate>
                            @csrf
                            @method('PUT')
    
                            <div class="flex flex-wrap mb-6">
                                <label for="name" class="block text-gray-700 text-sm mb-2">{{ __('Username') }}</label>
                                <input id="name" type="text" class="p-3 bg-gray-200 rounded form-input w-full @error('name') is-invalid @enderror" name="name" value={{Auth::user()->name }}  autocomplete="name" autofocus>
                            ...
                            <div class="flex flex-wrap mb-6">
                                ...
                                <input id="telephone" type="tel" class="p-3 bg-gray-200 rounded form-input w-full @error('telephone') is-invalid @enderror" name="telephone" value={{Auth::user()->telephone }}  autocomplete="telephone" autofocus>
                            ...
                            <div class="flex flex-wrap mb-6">
                                ...
                                <input id="email" type="email" class="p-3 bg-gray-200 rounded form-input w-full @error('email') is-invalid @enderror" name="email" value={{Auth::user()->email }}  autocomplete="email">
