                ...
                <div class="bg-gray-300 text-gray-700 uppercase text-center py-3 px-6 mb-0">
                    ...
                    <form class="py-10 px-5" method="POST" action="{{ route('login') }}" novalidate>
                        ...
                        <div class="flex flex-wrap mb-6">
                            <label for="email" class="block text-gray-800 text-sm mb-2">{{ __('E-Mail') }}</label>
                        ...
                        <div class="flex flex-wrap mb-6">
                            <label for="password" class="block text-gray-800 text-sm mb-2">{{ __('Password') }}</label>
                        ...
                        <div class="flex flex-wrap mb-6">
                            ...
                            <label class="block text-gray-800 text-sm mb-2" for="remember">
                                {{ __('Remember Me') }}
                            </label>
                        </div>
